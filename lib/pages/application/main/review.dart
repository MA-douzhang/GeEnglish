...
@RoutePage(name: "reviewPageRoute")
...
class _ReviewPageState extends State<ReviewPage> {
  ...
  void fetchData() async {
    var tmp = await getReviewData(context: context);
    setState(() {
    ...
    return Expanded(
      child: Column(
        children: <Widget>[
          divider10Px(),
//          _buildCard("音标", "eɪ"),
          _buildCard("翻译", data[index].translation as String ?? "暂无数据"),
          _buildCard("当前/总计",
