...
class CropPage extends StatefulWidget {
  ...
  CropPage({super.key,this.title, this.image, this.imageInfo});
...
class _CropPageState extends State<CropPage>
  ...
  String baiduApi = BAIDU_TOKEN_API;
  String baiduRestApi = BAIDU_REST_API;
  String baiduGrantType = "client_credentials";
  String baiduClientId = AK; //百度ocr api的 clientId,请自行申请
  String baiduClientSecret = SK; //百度ocr api的 Secret
  ...
  Future<ImageUtil.Image> copyCrop(ImageUtil.Image image, int corpX, int corpY,
    ...
    return Future(
        () => ImageUtil.copyCrop(image,x: corpX, y: corpY, width: corpWidth, height: corpHeight));
  }
  ...
  Future<void> _capturePng() async {
    ...
    var codec = await ui.instantiateImageCodec(byteList as Uint8List);
    ...
    List<String> ocrContent = List as List<String>;
    if (wordsNum > 0) {
    ...
    //     .pushNamed(Routes.resultPageRoute,
    //         arguments: ResultPageArguments(
    //             title: 'crop', ocrContent: ocrContent, image: frame.image))
    //     .then((value) {
    ...
    return new Stack(
      children: <Widget>[
        ...
        new Positioned(
          ...
          child: new GestureDetector(
              child: new Image.asset("assets/images/topLeft.png"),
        ...
        new Positioned(
          ...
          right: (MediaQuery.of(context).size.width -
              ...
              2),
          child: new GestureDetector(
              child: new Image.asset("assets/images/topRight.png"),
              onPanStart: onPanStart,
              onPanUpdate: (dragInfo) {
        ...
        new Positioned(
          ...
          left: this.maskLeft - 2,
          child: new GestureDetector(
              child: new Image.asset("assets/images/bottomLeft.png"),
              onPanStart: onPanStart,
              onPanUpdate: (dragInfo) {
        ...
        new Positioned(
          ...
          right: (MediaQuery.of(context).size.width -
              ...
              2),
          child: new GestureDetector(
            child: new Image.asset("assets/images/bottomRight.png"),
            onPanStart: onPanStart,
            onPanUpdate: (dragInfo) {
