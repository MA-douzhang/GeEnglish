...
Widget btnFlatButtonWidget({
  ...
  return Container(
    ...
    child: TextButton(
      style: ButtonStyle(backgroundColor: MaterialStateProperty.all(gbColor)),
      onPressed: onPressed,
      child: Text(
        title,
...
class CircleIconButton extends StatelessWidget {
  ...
  const CircleIconButton({super.key, this.size = 30.0, this.icon = Icons.clear, this.onPressed});
        ...
        Row(
          ...
          children: [
            widget.leftWidget != null
                ? widget.leftWidget as Widget
                : Expanded(
                    child: Container(),
                  ),
            _displaysRecordingButton(),
            widget.rightWidget != null
                ? widget.rightWidget as Widget
                : Expanded(
                    child: Container(),
                  ),
          ],
